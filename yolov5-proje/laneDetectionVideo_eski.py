...
def regionOfInterest(image):
    ...
    polygons = np.array([[(196, 720), (430, 585), (850, 585), (1084, 720)]])
    #polygons = np.array([[(int(width/6.53), height), (int(width/3.37), int(height/1.23)), (int(width/1.5), int(height/1.23)), (int(width/1.23), height)]])
...
def serit_takip(frame):
    ...
    imageWithLines = cv2.polylines(imageWithLines,
                                   [np.array([[(196, 720), (430, 585), (850, 585), (1084, 720)]]).reshape((-1, 1, 2))],
                                   True, (255, 0, 0), 2)
