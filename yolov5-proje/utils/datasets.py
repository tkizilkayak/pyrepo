...
import laneDetectionVideo as ld
import PID
...
class LoadStreams:  # multiple IP or RTSP cameras
    ...
    serit_stop = True  # berkay acilstop
    ...
    def __init__(self, sources='streams.txt', img_size=640, stride=32):
        ...
        for i, s in enumerate(sources):
            ...
            thread2 = Thread(target=self.serit, args=([i]), daemon=True)
    ...
    def serit(self, index):
        while 1:
            if self.serit_stop is True:
                PID.pid_reset()
            else:
                ld.serit_takip(self.imgs[index])
